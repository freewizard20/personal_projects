                        ...
                        <li class="collection-item" style="padding-left:11px !important;">
                          ...
                          <a href="#!">
                            <div class="z-depth-1 light-blue white-text waves-effect waves-light jeonbutton" v-bind:class="{orange:cardtype=='foreign'}" v-on:click="cardtype == 'foreign' ? cardtype = 'basic' : cardtype = 'foreign'">
                              <h6 style="margin:5px 10px;">외환</h6>
                            </div>
                          </a>
                          <a href="#!">
        ...
        countrymark: function() {
          ...
          switch (this.country) {
            case 'us':
              ...
              vuecurrencybar.usedcurrency = this.forex.us;
            ...
            case 'jp':
              ...
              vuecurrencybar.usedcurrency = this.forex.jp;
            ...
            case 'eu':
              ...
              vuecurrencybar.usedcurrency = this.forex.eu;
            ...
            case 'cn':
              ...
              vuecurrencybar.usedcurrency = this.forex.cn;
            ...
            case 'uk':
              ...
              vuecurrencybar.usedcurrency = this.forex.uk;
          ...
          if (this.cardratein == '') {
            ...
            switch (this.cardtype) {
              ...
              case 'kookmin':
                ...
                break;
              case 'foreign':
                vueresult.cardtypedisplay = "외환카드";
                tmp = '외환 수수료율 : 0.2%';
                this.cardrated = 0.002;
                break;
              case 'samsung':
