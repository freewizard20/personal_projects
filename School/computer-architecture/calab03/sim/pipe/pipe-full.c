...
long long gen_f_pc()
{
    return (((((ex_mem_curr->icode) == (I_JMP)) & !
          (ex_mem_curr->takebranch)) & ((if_id_curr->icode) == (I_NOP))) ? 
      (ex_mem_curr->vala) : ((((((id_ex_curr->icode) == (I_JMP)) & !
              (ex_mem_curr->takebranch)) & !((ex_mem_curr->icode) == 
              (I_ALU) || (ex_mem_curr->icode) == (I_IADDQ))) & (
            (id_ex_curr->ifun) == (ex_mem_curr->ifun))) & (
          (if_id_curr->icode) == (I_NOP))) ? (id_ex_curr->vala) : (((((
                (if_id_curr->icode) == (I_JMP)) & !
              (ex_mem_curr->takebranch)) & !((id_ex_curr->icode) == (I_ALU)
               || (id_ex_curr->icode) == (I_IADDQ))) & !(
            (ex_mem_curr->icode) == (I_ALU) || (ex_mem_curr->icode) == 
            (I_IADDQ) || (ex_mem_curr->icode) == (I_JMP) || 
            (ex_mem_curr->icode) == (I_RRMOVQ))) & ((if_id_curr->ifun) == 
          (ex_mem_curr->ifun))) ? (if_id_curr->valp) : ((
          (mem_wb_curr->icode) == (I_RET)) & ((if_id_curr->icode) == 
          (I_NOP))) ? (mem_wb_curr->valm) : (((if_id_curr->icode) == 
          (I_RET)) & ((id_ex_curr->icode) == (I_PUSHQ))) ? 
      (id_ex_curr->vala) : (pc_curr->pc));
}
...
{
    return ((imem_error) ? (F_NONE) : !((imem_icode) == (I_ALU) || 
        (imem_icode) == (I_JMP) || (imem_icode) == (I_RRMOVQ)) ? 1 : 
      (imem_ifun));
}
...
long long gen_aluA()
{
    return (((((id_ex_curr->icode) == (I_ALU)) & ((ex_mem_curr->icode) == 
            (I_MRMOVQ) || (ex_mem_curr->icode) == (I_POPQ))) & (
          (ex_mem_curr->destm) == (id_ex_curr->srca))) ? 
      (mem_wb_next->valm) : ((id_ex_curr->icode) == (I_RRMOVQ) || 
        (id_ex_curr->icode) == (I_ALU)) ? (id_ex_curr->vala) : (
...
long long gen_aluB()
{
    return (((((id_ex_curr->icode) == (I_ALU)) & ((ex_mem_curr->icode) == 
            (I_MRMOVQ) || (ex_mem_curr->icode) == (I_POPQ))) & (
          (ex_mem_curr->destm) == (id_ex_curr->srcb))) ? 
      (mem_wb_next->valm) : ((id_ex_curr->icode) == (I_RMMOVQ) || 
        (id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == (I_ALU)
         || (id_ex_curr->icode) == (I_CALL) || (id_ex_curr->icode) == 
        (I_PUSHQ) || (id_ex_curr->icode) == (I_RET) || (id_ex_curr->icode)
         == (I_POPQ) || (id_ex_curr->icode) == (I_IADDQ)) ? 
...
{
    return (((((id_ex_curr->srca) == (ex_mem_curr->destm)) & (
            (ex_mem_curr->icode) == (I_MRMOVQ) || (ex_mem_curr->icode) == 
            (I_POPQ))) & ((id_ex_curr->icode) == (I_RMMOVQ) || 
          (id_ex_curr->icode) == (I_PUSHQ))) ? (mem_wb_next->valm) : 
      (id_ex_curr->vala));
}
    ...
    return ((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
          (I_POPQ)) & (((((id_ex_curr->destm) == (id_ex_next->srca)) & !(
                (if_id_curr->icode) == (I_RMMOVQ) || (if_id_curr->icode)
                 == (I_ALU))) & !(((if_id_curr->icode) == (I_PUSHQ)) & (
                (if_id_next->icode) == (I_RET)))) | (((id_ex_curr->destm)
               == (id_ex_next->srcb)) & ((if_id_curr->icode) != (I_ALU)))))
       | (((((if_id_curr->icode) == (I_RET)) & ((id_ex_curr->icode) != 
              (I_PUSHQ))) | (((id_ex_curr->icode) == (I_RET)) & (
              (ex_mem_curr->icode) != (I_PUSHQ)))) | (((ex_mem_curr->icode)
             == (I_RET)) & ((mem_wb_curr->icode) != (I_PUSHQ)))));
}
...
{
    return ((((((((if_id_curr->icode) == (I_JMP)) & !
                (ex_mem_next->takebranch)) & !((id_ex_curr->icode) == 
                (I_ALU) || (id_ex_curr->icode) == (I_IADDQ))) & (
              (if_id_curr->ifun) == (id_ex_curr->ifun))) & !(!(
              (ex_mem_curr->icode) == (I_ALU) || (ex_mem_curr->icode) == 
              (I_IADDQ)) & ((if_id_curr->ifun) == (ex_mem_curr->ifun)))) | 
        (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
             & !(!((ex_mem_curr->icode) == (I_ALU) || (ex_mem_curr->icode)
                 == (I_IADDQ)) & ((id_ex_curr->ifun) == (ex_mem_curr->ifun)
                ))) & !((!((ex_mem_curr->icode) == (I_ALU) || 
                (ex_mem_curr->icode) == (I_IADDQ)) & !((mem_wb_curr->icode)
                 == (I_ALU) || (mem_wb_curr->icode) == (I_IADDQ) || 
                (mem_wb_curr->icode) == (I_JMP) || (mem_wb_curr->icode) == 
                (I_RRMOVQ))) & ((id_ex_curr->ifun) == 1)))) | (((((
                (if_id_curr->icode) == (I_RET)) & ((id_ex_curr->icode) != 
                (I_PUSHQ))) | (((id_ex_curr->icode) == (I_RET)) & (
                (ex_mem_curr->icode) != (I_PUSHQ)))) | ((
              (ex_mem_curr->icode) == (I_RET)) & ((mem_wb_curr->icode) != 
              (I_PUSHQ)))) & !(((id_ex_curr->icode) == (I_MRMOVQ) || 
            (id_ex_curr->icode) == (I_POPQ)) & (((((id_ex_curr->destm) == 
                  (id_ex_next->srca)) & !((if_id_curr->icode) == (I_RMMOVQ)
                   || (if_id_curr->icode) == (I_ALU))) & !((
                  (if_id_curr->icode) == (I_PUSHQ)) & ((if_id_next->icode)
                   != (I_RET)))) | (((id_ex_curr->destm) == 
                (id_ex_next->srcb)) & ((if_id_curr->icode) != (I_ALU)))))))
    ;
}
...
long long gen_E_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
               ...
               == (I_IADDQ)) & !((mem_wb_curr->icode) == (I_ALU) || 
              (mem_wb_curr->icode) == (I_IADDQ) || (mem_wb_curr->icode) == 
              (I_JMP) || (mem_wb_curr->icode) == (I_RRMOVQ))) & (
            (id_ex_curr->ifun) == 1))) | (((id_ex_curr->icode) == (I_MRMOVQ)
           || (id_ex_curr->icode) == (I_POPQ)) & ((((id_ex_curr->destm) == 
              (id_ex_next->srca)) & !((if_id_curr->icode) == (I_RMMOVQ) || 
              (if_id_curr->icode) == (I_PUSHQ) || (if_id_curr->icode) == 
              (I_ALU))) | (((id_ex_curr->destm) == (id_ex_next->srcb)) & (
              (if_id_curr->icode) != (I_ALU))))));
}
